(() => {
  ...
  const s = window.React,
    ...
    c = (e, t, o) => {
      const n = (
        (e, t) => (o) =>
          ((null == o ? void 0 : o.paymentRequirements) || []).every((e) =>
            t.includes(e)
          ) && e(o)
      )(e, t);
              ...
              Object.entries(t).forEach(([t, n]) => {
                ...
                (r = Object.keys(e).every((t) => {
                  try {
                    ...
                    return (
                      console.error(
                        `Error when executing callback for ${o} in ${t}`,
                        e
                      ),
                      !0
                    );
    ...
    d = window.wp.element,
    m = (e, t) => {
      if (null !== e && !(0, d.isValidElement)(e))
        throw new TypeError(
  ...
  class y {
    constructor(e) {
      ...
      i(this, "name", void 0),
        ...
        (this.supports = {
          showSavedCards:
            (null == e || null === (t = e.supports) || void 0 === t
              ? void 0
              : t.showSavedCards) ||
            (null == e || null === (o = e.supports) || void 0 === o
              ? void 0
              : o.savePaymentInfo) ||
            !1,
          showSaveOption:
            (null == e || null === (n = e.supports) || void 0 === n
              ? void 0
              : n.showSaveOption) || !1,
          features: (null == e || null === (r = e.supports) || void 0 === r
            ? void 0
            : r.features) || ["products"],
        }),
  ...
  i(y, "assertValidConfig", (e) => {
    ...
    if (
      ((e.savedTokenComponent =
        e.savedTokenComponent || (0, s.createElement)(h, null)),
      u(e, ["name", "label", "ariaLabel", "content", "edit", "canMakePayment"]),
      "string" != typeof e.name)
    )
      throw new Error(
        "The name property for the payment method must be a string"
      );
    if (void 0 !== e.icons && !Array.isArray(e.icons) && null !== e.icons)
      throw new Error(
    ...
    if (
      (((e, t) => {
        if (null !== e && !(0, d.isValidElement)(e) && "string" != typeof e)
          throw new TypeError(
    ...
    if (
      void 0 !==
        (null === (t = e.supports) || void 0 === t
          ...
          : t.showSavedCards) &&
      "boolean" !=
        typeof (null === (o = e.supports) || void 0 === o
          ? void 0
          : o.showSavedCards)
    )
      throw new TypeError(
    ...
    if (
      ...
      void 0 !==
        (null === (a = e.supports) || void 0 === a ? void 0 : a.features) &&
        !Array.isArray(
          null === (i = e.supports) || void 0 === i ? void 0 : i.features
        ))
    )
      throw new Error(
    ...
    if (
      void 0 !==
        (null === (l = e.supports) || void 0 === l
          ? void 0
          : l.showSaveOption) &&
      "boolean" !=
        typeof (null === (p = e.supports) || void 0 === p
          ? void 0
          : p.showSaveOption)
    )
      throw new TypeError(
  ...
  class f {
    constructor(e) {
      ...
      i(this, "name", void 0),
        ...
        (this.paymentMethodId = e.paymentMethodId || this.name),
        (this.supports = {
          features: (null == e || null === (t = e.supports) || void 0 === t
            ? void 0
            : t.features) || ["products"],
        }),
        (this.canMakePaymentFromConfig = e.canMakePayment);
  ...
  i(f, "assertValidConfig", (e) => {
    var t, o;
    if ((u(e, ["name", "content", "edit"]), "string" != typeof e.name))
      throw new TypeError(
    ...
    if (
      void 0 !==
        (null === (t = e.supports) || void 0 === t ? void 0 : t.features) &&
      !Array.isArray(
        null === (o = e.supports) || void 0 === o ? void 0 : o.features
      )
    )
      throw new Error(
        "The features property for the payment method must be an array or undefined."
  ...
  const v = "wc/store/payment",
    ...
    M = (e, t) => {
      l[e]
        ? console.error(
            `The namespace provided to registerPaymentMethodExtensionCallbacks must be unique. Callbacks have already been registered for the ${e} namespace.`
          )
        : ((l[e] = {}),
          Object.entries(t).forEach(([t, o]) => {
            "function" == typeof o
              ? (l[e][t] = o)
              : console.error(
                  `All callbacks provided to registerPaymentMethodExtensionCallbacks must be functions. The callback for the ${t} payment method in the ${e} namespace was not a function.`
                );
          }));
    },
    P = (e) => {
    ...
    T = (e) => {
      delete g[e];
      const { __internalRemoveAvailableExpressPaymentMethod: t } = (0,
      r.dispatch)(v);
      t(e);
    },
    C = () => b,
  ...
  function I(e) {
    return {
      ...("object" == typeof S[e] && Object.keys(S[e]).length > 0 ? S[e] : {}),
      ...S.any,
    };
  }
  function O(e) {
    return (
      n()("getRegisteredInnerBlocks", {
        version: "2.8.0",
  ...
  const x = (e, t, o) => {
      ...
      if (n !== o)
        throw new Error(
          `Incorrect value for the ${t} argument when registering a block component. It was a ${n}, but must be a ${o}.`
        );
    },
    j = (e, t) => {
      if (e[t]) {
  ...
  function B(e) {
    e.context || (e.context = "any"),
      x(e, "context", "string"),
      x(e, "blockName", "string"),
      j(e, "component");
    const { context: t, blockName: o, component: n } = e;
    S[t] || (S[t] = {}), (S[t][o] = n);
  }
  function R(e) {
    n()("registerInnerBlock", {
      version: "2.8.0",
