  ...
  var n,
    ...
    T = function (e) {
      "hidden" === document.visibilityState &&
        h > -1 &&
        ((h = "visibilitychange" === e.type ? e.timeStamp : 0), E());
    },
    y = function () {
              ...
              e.forEach(function (e) {
                "first-contentful-paint" === e.name &&
                  ...
                  e.startTime < r.firstHiddenTime &&
                    ((i.value = Math.max(e.startTime - s(), 0)),
                    i.entries.push(e),
                    t(!0)));
              });
            });
          o &&
            ((t = l(e, i, S, n.reportAllChanges)),
            c(function (r) {
              (i = f("FCP")),
                (t = l(e, i, S, n.reportAllChanges)),
                p(function () {
    ...
    q = function (e) {
      ...
      return (
        (e = m(e)),
        "hidden" === document.visibilityState ? e() : ((t = n(e)), v(e)),
        t
      );
    },
    O = [200, 500],
        ...
        "pointerdown" == e.type
          ? (function (e, n) {
              var t = function () {
                ...
                i = function () {
                  removeEventListener("pointerup", t, G),
                    removeEventListener("pointercancel", r, G);
                };
              addEventListener("pointerup", t, G),
  ...
  return (
      ...
      (n = n || {}),
        L(function () {
          ...
          if (a) {
            ...
            var u = m(function () {
              V[i.id] ||
                (o(a.takeRecords()), a.disconnect(), (V[i.id] = !0), t(!0));
            });
    ...
    (e.onTTFB = function (e, n) {
      ...
      z(function () {
        var i = u();
        i &&
          ((t.value = Math.max(i.responseStart - s(), 0)),
          (t.entries = [i]),
          r(!0),
          c(function () {
