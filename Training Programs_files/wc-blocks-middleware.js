(() => {
  ...
  try {
    const e = window.localStorage.getItem("storeApiNonce"),
      t = e ? JSON.parse(e) : {};
    (r = (null == t ? void 0 : t.nonce) || ""),
      (a = (null == t ? void 0 : t.timestamp) || 0);
  } catch {}
  const c = (e, t) => {
      e !== r &&
        ((a && t < a) ||
          ...
          window.localStorage.setItem(
            "storeApiNonce",
            JSON.stringify({ nonce: r, timestamp: a })
          )));
    },
    i = (e) => {
      const t = e.headers || {};
  ...
  n().use((e, t) => {
    ...
    return (
      ((e) => {
        ...
        return (
          !(!t || !e.method || "GET" === e.method) &&
          null !== /wc\/store\/v1\//.exec(t)
        );
      })(e) &&
        ((e = i(e)),
        Array.isArray(
          null === (o = e) ||
            ...
            ? void 0
            : n.requests
        ) && (e.data.requests = e.data.requests.map(i))),
      t(e, t)
    );
  }),
    (n().setNonce = (e) => {
