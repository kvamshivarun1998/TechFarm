(() => {
  ...
  e.r(t),
    ...
    (0, window.wp.hooks.addFilter)(
      ...
      (e) => {
        const t = (e) =>
            "customStatuses" === e.key
              ? {
                  ...e,
                  options: e.options.filter(
                    (e) => "checkout-draft" !== e.value
                  ),
                }
              : e,
        ...
        return {
          ...
          woocommerce_actionable_order_statuses: {
            ...e.woocommerce_actionable_order_statuses,
            options: r,
          },
          woocommerce_excluded_report_order_statuses: {
            ...e.woocommerce_excluded_report_order_statuses,
            options: o,
          },
        };
      }
  ...
  const U =
    ...
    v = (e, t) => {
      if (I(e) || I(t)) return 0;
      const [r, o] = ((e, t) =>
        typeof e != typeof t ? [String(e), String(t)] : [e, t])(b(e), b(t));
    ...
    L = (e) => {
      ...
      if (-1 === O.indexOf(e))
        throw new Error(`Invalid operator, expected one of ${O.join("|")}`);
    },
    ...
    P = (e, t, r) => {
      ...
      return (
        (o = o.endsWith(".") ? o.substring(0, o.length - 1) : o),
        y.compare(o, t, r)
      );
    },
    ...
    V = (e, t = null) => {
      var r;
      return null !== (r = x("paymentMethodData", {})[e]) && void 0 !== r
        ? r
        : t;
    },
    W = x("defaultFields");
